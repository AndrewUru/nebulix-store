---
title: El Salto Web Desarrollo Web Dinámico y Eficiente
description: "Transformamos tus ideas en realidades digitales: diseño web, ecommerce, portafolios, menús de restaurante y más."
intro: "Haz que tu negocio destaque con soluciones personalizadas y sitios rápidos, accesibles y atractivos."
hero_template: image
template: full
container: md
hero_buttons:
    ...
    features:
      - content: >
          ### Tailwind CSS
           ...
           Crea un sitio web único adaptado a la personalidad y necesidades de tu marca.
      ...
      - color: bg-[#fc0] text-black
        ...
        content: >
          ...
          Simplifica la venta de productos y servicios con integración de herramientas como WooCommerce o Snipcart.
      - icon: /src/icons/blocks-group-solid.svg
        content: >
          ### Page Block Builder


          Aumenta tu visibilidad en buscadores y atrae a más clientes con estrategias SEO efectivas.
      ...
      - content: >
          ...
          Diseñamos sitios que cumplen con estándares WCAG para ofrecer una experiencia inclusiva a todos los usuarios.
      ...
      - icon: /src/icons/template.svg
        content: >
          ### Multiple Templates
            ...
            Con tecnologías como Astro y optimización avanzada, tus páginas cargan en un abrir y cerrar de ojos, ofreciendo una experiencia de usuario superior.
        href: ""
      - icon: /src/icons/menu.svg
        content: >
          ...
          Desde menús para restaurantes hasta portafolios profesionales y tiendas online, ofrecemos soluciones completas para destacar en el entorno digital.
